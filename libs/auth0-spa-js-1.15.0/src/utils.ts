...
export const runIframe = (
  ...
  return new Promise<AuthenticationResult>((res, rej) => {
    console.log('runIframe:40', {
      authorizeUrl, eventOrigin, timeoutInSeconds
    });

    const iframe = window.document.createElement('iframe');

    console.log('runIframe:42', {
      iframe
    });
    ...
    window.addEventListener('onerror', iframeEventHandler, false);
    ...
    console.log('appended iframe and set authorizeUrl');
  });
};
