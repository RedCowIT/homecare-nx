...
export default class Auth0Client {
  ...
  public async handleRedirectCallback(
    ...
    if (!transaction || !transaction.code_verifier) {
      console.log('handleRedirectCallback.invalid state');
      throw new Error('Invalid state');
    }
    ...
    console.log('handleRedirectCallback.verifying:584');
    const decodedToken = this._verifyIdToken(
      authResult.id_token,
      transaction.nonce,
    ...
    console.log('handleRedirectCallback.AUTHENTICATED! :)');
    return {
